...
// of the 36 v56 events. The narrower v53 limits above remain the only online
// model-support gate.
...
// V46 MEKF + dynamic-beta Madgwick comparison. The MEKF is the adopted
// control/detector attitude source; the existing dynamic-beta Madgwick remains
// available as an online comparison signal for later video-synchronized analysis.
static constexpr float MEKF_GYRO_NOISE_STD_RAD_S = 0.015f;
static constexpr float MEKF_GYRO_BIAS_RW_STD_RAD_S_SQRT_S = 0.0008f;
static constexpr float MEKF_ACCEL_DIRECTION_NOISE_STD = 0.035f;
static constexpr float MEKF_ACCEL_MAG_FULL_G = 0.08f;
static constexpr float MEKF_ACCEL_MAG_REJECT_G = 0.30f;
static constexpr float MEKF_ACCEL_ANGLE_FULL_DEG = 6.0f;
static constexpr float MEKF_ACCEL_ANGLE_REJECT_DEG = 22.0f;
static constexpr float MEKF_ACCEL_MIN_CONFIDENCE = 0.05f;
static constexpr float MEKF_MIN_DT_S = 0.0005f;
static constexpr float MEKF_MAX_DT_S = 0.0500f;
